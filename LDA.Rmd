...
coherence_lda <- evaluate_coherence(max_K = 20, corpus_ita, save_results = TRUE)
...
<<<<<<< HEAD
lda_model_ita <- one_model_analysis(num_topics = 8, corpus_ita, save_results = FALSE)
=======
lda_model_ita <- one_model_analysis(num_topics = 12, corpus_ita, save_results = TRUE)
>>>>>>> 3abe43caf6b704687b52bdd872fdef1d9b0cb7d5
```
