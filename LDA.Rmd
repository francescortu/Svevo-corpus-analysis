...
lda_model_ita$labels <- c("libro", "famiglia", "famiglia", "malattia", "libro", "viaggio", "viaggio", "pensieri", "famiglia", "pensieri")
...
names(topic_time)[1:10] <- lda_model_ita$labels
