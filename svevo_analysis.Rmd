...
candidate_k <- seq(2,20,2) # candidates for how many topics
...
# max_K <- 20
# system.time({
# multiple_K_coherence <- foreach(j = 1:length(candidate_k), .combine = rbind) %dopar%{
#   k <- candidate_k[j]
#   set.seed(12345)
#   coher <- c(1:max_K)
#   for(i in c(1:max_K)){
...
# 
# stopCluster(cluster)
# coherence <- as.data.frame(multiple_K_coherence)
